...
const FoodCard = (props) => {
    return (
        ...
        <div className="container-fluid restaurants-big">
            <div className="row foodcard-wrapper w-100">

                {/*columnas del contenedor*/}
                <div className="col-xs-12 col-sm-12 col-md-4 medium-center">
                ...
                <div className="col-xs-12 col-sm-12 col-md-8 product-texts medium-center">
